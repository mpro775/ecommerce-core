...
export class EmailService {
  ...
  async sendStaffInvite(input: StaffInviteEmailInput): Promise<void> {
    ...
    const text = [
      ...
      '',
      `You have been invited to join ${input.storeName} on Kaleem Store.`,
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; color: #111; line-height: 1.6;">
        ...
        <p>You have been invited to join <strong>${this.escapeHtml(input.storeName)}</strong> on Kaleem Store.</p>
