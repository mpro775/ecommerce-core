...
const WEAK_SECRET_VALUES = [
  ...
  'kaleem-local-platform-secret',
  'kaleem-local-access-secret-change-me',
  'kaleem-local-customer-access-secret-change-me',
  'kaleem-local-owner-registration-otp-secret-change-me',
  'kaleem-local-token-hash-secret-change-me',
  'kaleem-local-webhook-secret',
  'kaleem-local-billing-webhook-secret',
];
...
export const envValidationSchema = Joi.object({
  ...
  PLATFORM_ADMIN_SECRET: productionSecret(32, 'kaleem-local-platform-secret'),
  TOKEN_HASH_SECRET: Joi.when('NODE_ENV', {
    ...
    then: Joi.string()
      ...
      .invalid(...WEAK_SECRET_VALUES)
      .required(),
    otherwise: Joi.string().min(24).default('kaleem-local-token-hash-secret-change-me'),
  }),
  JWT_ACCESS_SECRET: productionSecret(32, 'kaleem-local-access-secret-change-me'),
  ...
  AUTH_OTP_SECRET: productionSecret(32, 'kaleem-local-owner-registration-otp-secret-change-me'),
  ...
  WEBHOOK_SECRET: productionSecret(32, 'kaleem-local-webhook-secret'),
  BILLING_WEBHOOK_SECRET: productionSecret(32, 'kaleem-local-billing-webhook-secret'),
  JWT_CUSTOMER_ACCESS_SECRET: productionSecret(32, 'kaleem-local-customer-access-secret-change-me'),
